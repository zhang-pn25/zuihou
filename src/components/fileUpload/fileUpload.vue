  ...
  export default {
      ...
      fileOtherData: {
        ...
        default: function() {
          return {
            ...
            bizId: "",
            bizType: "",
            org:this.$store.state.account.user.orgId,
            task:this.$route.query.id?this.$route.query.id:'',
            isSingle: false
          };
        }
      }
    ...
    methods: {
      ...
      init({ id, bizId, bizType, isSingle, isDetail }) {
        ...
        vm.org = this.$store.state.account.user.orgId;
         vm.task = this.$route.query.id?this.$route.query.id:'';
