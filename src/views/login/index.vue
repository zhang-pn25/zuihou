  ...
  <div class="login-container">
    ...
    >
      ...
      <span v-if="login.type === 'up'">
        <el-form-item prop="tenant" v-show="false">
          <el-input
...
<style lang="scss" scoped>
  ...
  .login-container {
    ...
    .login-form {
      ...
      height: 440px;
      padding: 55px;
      border: 1px solid #1E70F9;
      background: #02187B;
      box-shadow: 0px 0px 5px 1px #1E70F9;
      color: #FFF;
      /*background: linear-gradient(to top, #041E57 40%, #021945 100%);*/
      border-radius: 3px;
    ...
    .title-container {
      ...
      .title {
        font-size: 20px;
        color: #D1B741;
        text-shadow: 1px 1px 3px #1046CC;
