      ...
      return{
        ...
        tabList:[
          {"accountingTestTaskId": 0,
            checkTime:'2021-01-12',
            checkResult:'阴性',
            isAbnormal:'否',
            notDetectedReason:'无',
            checkResultProve:'核酸检测为阴性',
            "beforeCompany": "",
            "checkAddress": "天津医院",
            "checkType": "鼻拭子",
            "company": {
