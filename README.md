...
zuihou-ui 是[核酸检测系统](https://github.com/zuihou/核酸检测系统)微服务权限系统的 `租户后台`，基于[vue element admin](https://panjiachen.github.io/vue-element-admin-site/zh/)构建。

所谓`租户后台`，即是给租户（客户）使用，而`开发&运营后台`则是给使用此框架的公司内部人员维护项目使用。

## 如果您觉得有帮助，请点右上角 "Star" 支持一下，谢谢!!

## 详细文档: https://www.kancloud.cn/zuihou/核酸检测系统

http://doc.tangyh.top/核酸检测系统

    ps: gitee捐献 或者 二维码打赏（本页最下方）： 45元及以上 备注邮箱，可得开发文档一份（支持后续更新） （比看云的价格便宜哦）

## 交流群： 63202894

![qq群.png](image/qq群.png) <a target="_blank" href="http://shang.qq.com/wpa/qunwpa?idkey=489800b9d07d017fa0b5104608a4bf755f1f38276b79f0ac5e6225d0d9897efb"><img border="0" src="http://pub.idqqimg.com/wpa/images/group.png" alt="核酸检测系统 交流" title="核酸检测系统 交流"></a>
...
| 项目          | gitee                                          | github                                       |
| ------------- | ---------------------------------------------- | -------------------------------------------- |
| 微服务项目    | https://gitee.com/zuihou111/核酸检测系统 | https://github.com/zuihou/核酸检测系统 |
...
由于本项目为了同时支持 核酸检测系统 和 zuihou-admin-boot 2 个项目，但前者由于多了一个网关服务，所以在请求 URI 上比后者多了一段 网关的 URI，
...
本人感激不尽，并赠送后端文档（https://kancloud.cn/zuihou/核酸检测系统）一份，且提供核酸检测系统项目的任何支持（启动运行，报错，二次开发，部署等）。
